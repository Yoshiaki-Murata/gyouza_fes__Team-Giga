...
<head>
    ...
    <meta name="description" content="ふくおか餃子フェスに関する問い合わせページ。">
    <title>お問い合わせ内容確認｜ふくおか餃子FES</title>
...
<body id="top">
    ...
    <main>
        <section class="l-wrapper">
            <h1 class="c-title__main" data-sub-title="内容確認">Confirm</h1>
            <p class="c-contact__text">お問い合わせ内容はこちらでお間違いないですか？
